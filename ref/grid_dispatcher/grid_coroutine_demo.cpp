...
using barrier_t = grid_barrier_t<void, worker_t>;
using barrier_warp_t = grid_barrier_t<warp_t>; // worker_t implicit deduced from warp_t
using frame_t = grid_frame_t<void, worker_t>;
using frame_warp_t = grid_frame_t<warp_t, worker_t>;
